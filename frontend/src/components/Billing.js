          ...
          {!loading && !predictions && !analysisData && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12">
              <div className="text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Aucune analyse ML disponible</h3>
                <p className="text-gray-500 mb-6">Lancez une analyse pour obtenir des prédictions avancées</p>
                <button
                  onClick={() => {
                    setLoading(true);
                    loadAllPredictionsData().finally(() => setLoading(false));
